from parse_csv import split_csv, split_csv2, strip_quotes, split_row_3, split_csv3, split_row, split_csv4
...
def test_split_2():
    assert  split_csv2(test_string_2) == table1
...
def test_split_3():
    ...
    assert  split_csv3(test_string_3) == table2
...
def test_split_4():
    assert split_csv4(test_string_4) == table3
